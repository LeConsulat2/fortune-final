        ...
        <div className="space-y-10">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              <a href="/privacy">Privacy Policy</a>, which outlines how we handle session data and browser-based
          ...
          <section>
            ...
            <ul className="space-y-2 text-muted-foreground">
              ...
              <li>• You may not attempt to access, copy, reverse-engineer, or exploit any part of the Service or its underlying architecture.</li>
              <li>• Automated scraping, cloning, or replication of generated content or API endpoints is strictly prohibited.</li>
            </ul>
          </section>
